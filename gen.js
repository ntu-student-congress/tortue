		...
		var laws_latex = laws.map(function(law) {
			...
			var formatted_lines = law_data[2].split("\n").map(function(element, index, array) {
				...
				switch(element.search(/\S/) / 2){
					...
					case 2: // 項
						return "\\begingroup\\raggedright\\leftskip=0em\\hspace{0em}\\vspace{0em}" + text + " \\par\\endgroup";
					case 3: // 款
						return "\\begingroup\\raggedright\\leftskip=4em\\hspace{-2em}\\vspace{0em}" + text + " \\par\\endgroup";
					case 4: // 目
						return "\\begingroup\\raggedright\\leftskip=6em\\hspace{-2em}\\vspace{0em}" + text + " \\par\\endgroup";
					default:
						return "";
				}
			});
